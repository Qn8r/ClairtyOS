...
class ClarityWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        ...
        fun updateAll(context: Context) {
            ...
            val component = ComponentName(context, ClarityWidgetProvider::class.java)
        ...
        private fun updateWidgets(context: Context, manager: AppWidgetManager, ids: IntArray) {
            ...
            val quickIntent = Intent(context, ClarityWidgetProvider::class.java).apply { action = ACTION_QUICK_COMPLETE }
            ...
            ids.forEach { id ->
                val rv = RemoteViews(context.packageName, R.layout.clarityos_widget)
                rv.setTextViewText(R.id.widgetTitle, "ClarityOS Today")
